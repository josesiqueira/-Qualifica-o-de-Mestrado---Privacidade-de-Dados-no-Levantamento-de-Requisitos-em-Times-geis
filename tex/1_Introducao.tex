  \label{introducao}
%Ir periodicamente colocando artigos Dropbox Edna no meu Privacidade_DropBox_Edna no Mendeley
%Se eu achar artigo que eu vou usar e não está no Dropbox, enviar para a Edna

%Iniciando a escrita da Introducao. Lendo artigos sobre Requisitos de Privacidade a fim de encontrar questões de pesquisa que me guiem. Por isso, a introdução é crucial. Porém, já posso ir inserindo autores e artigos que serão utilizados no Cap 2. Lembrei que no Cap 2 já tem muita coisa pronta dos artigos de Privacidade!!! Esperar mãozinha da Edna
